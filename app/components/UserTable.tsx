...
const TableHeader: FC = () => (
    <thead>
        <tr>
            <th className="px-16 pr-28  text-center text-gray-600 font-semibold">Name</th>
            <th className="px-16 pr-28 text-center text-gray-600 font-semibold">Email</th>
            <th className="px-10 pr-28 text-center text-gray-600 font-semibold">Account Status</th>
        </tr>
    </thead>
);
...
const UserTable: FC = () => {
    ...
    return (
        <div className="w-[640px] p-6 bg-white rounded-lg shadow-lg h-86 ml-4"> {/* Increased height */}
            <div className="flex justify-between items-center mb-4">
                <h2 className="text-Secondary font-semibold text-lg">Application Users</h2>
                {/* Tab Navigation */}
            ...
            {/* User Table */}
            <div className="overflow-hidden h-60"> {/* Increased height */}
                <table className="min-w-full bg-white">
                    {/* Fixed Header */}
                    <TableHeader />
                </table>
                {/* Scrollable Body */}
                <div className="overflow-y-auto h-48"> {/* Increased height */}
                    <table className="min-w-full bg-white">
                        <tbody>
